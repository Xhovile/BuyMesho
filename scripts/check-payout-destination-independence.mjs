...
const checks = [
  ...
  ['New destinations become verified', source.destinationHelper.includes("verification_status, verification_attempts, last_error, verified_at") && source.destinationHelper.includes("VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'verified'"),],
