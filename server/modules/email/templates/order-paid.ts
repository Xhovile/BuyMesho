...
export function renderOrderPaidEmail(params: {
  ...
  const formattedTotal = `${params.totalAmount.toLocaleString(undefined, {
  ...
  const intro = isBuyer
    ? "Your payment has been confirmed and your BuyMesho order is now being processed."
    : "A buyer has successfully paid for an order connected to your BuyMesho listing.";
  const buttonLabel = isBuyer ? "View order" : "View order";
  ...
  const html = `
    <div style="font-family: Arial, Helvetica, sans-serif; line-height: 1.6; color: #111827;">
      ...
      <p style="margin: 0; font-size: 14px; color: #6b7280;">
        If you did not expect this message, please contact BuyMesho Support.
      </p>
    </div>
  `;
