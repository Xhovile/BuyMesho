...
/**
 * Keeps the production payment_webhook_events schema compatible with the
 * webhook persistence layer. This is intentionally idempotent because the
 * application starts through bootstrap.ts in every environment.
 */
export function ensurePaymentWebhookEventSchema(db: PgCompatDatabase): void {
  db.exec(`
