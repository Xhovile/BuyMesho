...
db.exec(`
  ...
  ALTER TABLE listings ADD COLUMN IF NOT EXISTS category TEXT NOT NULL DEFAULT '';
  ALTER TABLE listings ADD COLUMN IF NOT EXISTS university TEXT NOT NULL DEFAULT '';
