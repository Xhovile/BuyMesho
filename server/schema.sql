...
CREATE TABLE IF NOT EXISTS seller_applications (
  ...
  offers_layby INTEGER NOT NULL DEFAULT 0,
  layby_audience TEXT,
  offers_financing INTEGER NOT NULL DEFAULT 0,
  provides_delivery INTEGER NOT NULL DEFAULT 0,
  offers_deals INTEGER NOT NULL DEFAULT 0,
  participates_student_offers INTEGER NOT NULL DEFAULT 0,
  student_offer_categories TEXT NOT NULL DEFAULT '[]',
  student_offer_percentage INTEGER,
  created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
