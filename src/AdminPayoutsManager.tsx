                  ...
                  <tr key={row.id} className="cursor-pointer hover:bg-zinc-50" onClick={() => setSelectedId(row.id)}>
                    ...
                    <td className="px-4 py-4 text-zinc-600">
                      <div className="space-y-0.5">
                        <div className="font-semibold text-zinc-900">{row.sellerBusinessName || row.sellerId || "—"}</div>
                        {row.sellerBusinessName && row.sellerId ? <div className="text-xs text-zinc-500">{row.sellerId}</div> : null}
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-4 text-zinc-600">{toDate(row.updatedAt || row.createdAt)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
