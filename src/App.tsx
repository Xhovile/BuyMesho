              ...
              {!userSeller ? (
                ...
                <form onSubmit={handleCreateListing} className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-xs font-bold text-zinc-400 uppercase mb-1">Campus</label>
                      <select 
                        className="w-full px-4 py-2 bg-zinc-50 border border-zinc-200 rounded-xl focus:ring-2 focus:ring-primary/20 outline-none"
                ...
                {isFirebaseConfigured && !firestoreError && authView === 'signup' && (
                  <form onSubmit={handleSignUp} className="p-8 space-y-4">
                    <p className="text-sm text-zinc-500">
                      Create a regular BuyMesho account first. You can become a seller later.
                    </p>
                    ...
                    <div>
                      <label className="block text-xs font-bold text-zinc-400 uppercase mb-1">Profile Photo (Optional)</label>
                    ...
                    <div>
                      <label className="block text-xs font-bold text-zinc-400 uppercase mb-1">About You (Optional)</label>
                      <textarea 
                        ...
                        <div className="flex items-center gap-2 justify-center">
                          ...
                          <span>
                            {isSellerAccount
                              ...
                              : "Verify your email to secure your account and unlock seller access later"}
                          </span>
                        </div>
