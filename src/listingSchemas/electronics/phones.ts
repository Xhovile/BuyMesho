...
export const SMARTPHONE_FIELD_GROUPS: ListingFieldGroup[] = [
  {
...
export const FEATURE_PHONE_FIELD_GROUPS: ListingFieldGroup[] = [
  {
    title: "Phone Identity",
...
export const TABLET_FIELD_GROUPS: ListingFieldGroup[] = [
  {
...
export const SMARTWATCH_FITNESS_BAND_FIELD_GROUPS: ListingFieldGroup[] = [
  {
    title: "Device Identity",
