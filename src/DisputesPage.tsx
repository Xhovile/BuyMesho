    ...
    <div className="min-h-screen bg-zinc-100 text-zinc-900">
      ...
      <div className="mx-auto max-w-5xl px-4 py-6 sm:py-10">
        <header className="flex items-start gap-3">
          ...
          <div><p className="text-xs font-black uppercase tracking-[0.28em] text-zinc-500 sm:text-sm">Disputes</p><h1 className="mt-1 text-4xl font-black tracking-tight text-zinc-950 sm:text-5xl">Report a problem</h1><p className="mt-2 max-w-2xl text-sm leading-7 text-zinc-600 sm:text-base">One place to request a return, request a refund, or ask BuyMesho to review any issue with an order or event ticket.</p></div>
        </header>
