...
import AdminPaymentDetailsDrawer, {
  type PaymentRow,
  type WebhookEventRow,
} from "./AdminPaymentDetailsDrawer";
...
export default function AdminPaymentsConsole() {
  ...
  return (
    ...
    >
      ...
      {selectedPayment ? <AdminPaymentDetailsDrawer payment={selectedPayment} hooks={selectedHooks} onClose={() => setSelectedReference(null)} /> : null}
    </AdminWorkspaceLayout>
  );
}
