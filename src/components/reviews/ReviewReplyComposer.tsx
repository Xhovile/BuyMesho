  ...
  return (
    <div className="mt-4 rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
      <button
        ...
        className="flex w-full items-center justify-between gap-3 rounded-xl bg-zinc-100 px-3 py-2 text-left text-sm font-bold text-zinc-700 transition hover:bg-zinc-200"
        aria-expanded={open}
      >
