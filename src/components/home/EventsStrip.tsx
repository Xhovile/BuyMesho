        ...
        {loading ? (
          ...
          events.map((item) => {
            ...
            return (
              <article
                key={item.id}
                className="group flex h-full w-[220px] shrink-0 snap-start flex-col overflow-hidden rounded-3xl border border-zinc-200 bg-white text-left shadow-sm transition-shadow hover:shadow-md sm:w-[260px]"
              >
