      ...
      {expanded ? <div className="divide-y divide-zinc-100">
        ...
        <div className="px-5 py-4 bg-white">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-sm font-extrabold text-zinc-900 inline-flex items-center gap-2"><span className="w-6 h-6 rounded-xl bg-zinc-100 text-zinc-700 inline-flex items-center justify-center"><KeyRound className="w-3.5 h-3.5" /></span>Passkeys</p>
              <p className="mt-1 text-xs text-zinc-500">Use your fingerprint, Face ID, device PIN, or security key to sign in.</p>
            </div>
