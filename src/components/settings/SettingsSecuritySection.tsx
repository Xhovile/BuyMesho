  ...
  return (
    <section className="overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm">
      ...
      {expanded ? <div className="divide-y divide-zinc-100">
        ...
        <button type="button" onClick={() => setTimeout(() => {}, 0)} disabled={verifiedAccountRequiredDisabled} className="hidden" aria-hidden="true" />
        <button type="button" onClick={on2FAEntry} disabled={verifiedAccountRequiredDisabled || totpLoading} className="hidden" aria-hidden="true" />
