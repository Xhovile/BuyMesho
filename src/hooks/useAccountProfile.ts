      ...
      try {
        ...
        if (loadedProfile) {
            ...
            try {
              ...
              if (application?.status === "approved") {
                ...
                try {
                  ...
                  console.warn("Skipped persisting seller status to Firestore:", firestoreWriteErr);
                }
          ...
          const fallbackProfile: UserProfile = {
            ...
            is_verified: !!firebaseUser.emailVerified,
            is_seller: getCachedSellerStatus(firebaseUser.uid),
          ...
          try {
            ...
            if (snap.exists()) {
              ...
              try {
                ...
                console.warn("Firestore profile bootstrap skipped:", firestoreWriteErr);
              }
              setProfile(fallbackProfile);
            }
          } catch (firestoreReadErr) {
            console.warn("Firestore profile read offline/failed, using fallback profile:", firestoreReadErr);
            setProfile(fallbackProfile);
          }
          setError(null);
        }
      } catch (err: any) {
        console.warn("Account profile load fallback engaged:", err);
        ...
        try {
          ...
          console.warn("Profile bootstrap fallback notice:", bootstrapErr);
        }
